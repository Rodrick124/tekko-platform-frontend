import { Clock3, Coins, ThumbsUp, UsersRound } from "lucide-react";
const stats = [
  {
    value: "480+",
    label: "Artisans audités",
    icon: UsersRound,
    tone: "bg-blue-100 text-blue-700",
  },
  {
    value: "100 FCFA",
    label: "Accès direct 24h",
    icon: Coins,
...
function StatsSection() {
  return (
    <section className="bg-[#eff4ff] py-6" aria-label="Chiffres clés">
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-3 px-4 md:grid-cols-4 lg:px-8">
        {stats.map(({ value, label, icon: Icon, tone }) => (
          ...
          >
            ...
            <span>
              <strong className="block text-xl leading-tight md:text-2xl">
                {value}
              </strong>
